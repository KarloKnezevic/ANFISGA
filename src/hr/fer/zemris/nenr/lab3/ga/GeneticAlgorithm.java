 ...
 * Characteristics:
 * o double chromosome
 * o generation algorithm
 * o embedded elitism
 * o crossing: simple arithmetic recombination
 * o mutation: simple mutation
 * o selection: proportional selection (Roulette Wheel)
 * 
...
public class GeneticAlgorithm implements IFuzzyNeuralGenetic {
	 ...
	 */
	public GeneticAlgorithm(double χ0, double μ0, int populationSize,
			int generations, Random rand, IFitness fitness, 
			boolean constConclusion, Pair[] intervals, 
			boolean parallelFitness, boolean dynamicχμUpdate) {
			...
			if (param != null) {
				...
				if (generation % 100 == 0) {
					System.out.println("Generation: " + generation + 
							" Error: " + best.fitness + 
							" Completeness:" + (double)generation/generations*100 + "%");
				}
			} else {
				System.out.println("Generation: " + generation + 
						" Error: " + best.fitness + 
	...
	/**
	 * Mutation.
	 * Each chromosome knows to mutate each bit.
	 * @param child
	 */
	 ...
	 * @param child2
	 */
	private void crossing(FloatChromosome parent1, FloatChromosome parent2,
			FloatChromosome child1, FloatChromosome child2) {
	 ...
	 * @param cpy
	 */
	private void copy(FloatChromosome org,
			FloatChromosome cpy) {
	...
	/**
	 * Parallel evaluation.
	 * Using ExecutorService and Fixed Thread Pool.
	 * @param population
	 */
	 ...
	 * @return
	 */
	private FloatChromosome[] makePopulation(FloatChromosomeDecoder decoder,
			boolean randomFill) {

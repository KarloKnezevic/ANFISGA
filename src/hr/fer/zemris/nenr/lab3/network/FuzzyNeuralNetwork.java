...
public class FuzzyNeuralNetwork {
	...
	/**
	 * Printing the relative error between 
	 * the learned and the true value.
	 * @param learningDataset
	 */
	...
	/**
	 * Print best individual average fitness 
	 * through generations.
	 * @param μ mutation
	 * @param times
	 * @param learningDataset
	...
	/**
	 * Print best individual average fitness 
	 * through generations for each mutation probability value.
	 * @param μ array of mutation probabilities
	 * @param times
	 * @param learningDataset
	 */
	public void trainAndWriteAverageValue(double[] μ, int times, List<Pair> learningDataset) {

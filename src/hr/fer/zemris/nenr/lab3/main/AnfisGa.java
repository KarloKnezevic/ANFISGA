package hr.fer.zemris.nenr.lab3.main;

import java.util.Random;

import hr.fer.zemris.nenr.lab3.dataset.Dataset;
import hr.fer.zemris.nenr.lab3.ga.GeneticAlgorithm;
import hr.fer.zemris.nenr.lab3.ga.IFuzzyNeuralGenetic;
import hr.fer.zemris.nenr.lab3.network.FuzzyNeuralNetwork;
import hr.fer.zemris.nenr.lab3.network.NetworkOutput;
import hr.fer.zemris.nenr.lab3.util.Pair;

/**
 * ANFISGA.
 * ANFIS learned by Genetic Algorithm.
...
public class AnfisGa {
	...
	public static void main(String[] args) {
		...
		//genetic algorithm
		IFuzzyNeuralGenetic ga = new GeneticAlgorithm(
				χ, 
				μ, 
				populationSize, 
		...
		if (constConclusion) {
			...
			network.trainAndWriteAverageValue(
					M, 5, dataset.getTrainingSet()
					);
		}
